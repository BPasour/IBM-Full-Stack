...
import { removeItemFromCart, clearCart, increaseItemQuantity, decreaseItemQuantity, addItemToCart } from './CartSlice'; // Assuming you have action creators for increasing and decreasing item quantity
